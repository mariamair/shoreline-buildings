...
def insert_shoreline_buildings_batch(conn, csv_file, regions, building_types, batch_size=5000):
    ...
    try:
            ...
            for idx, row in enumerate(reader, 1):
                try:
                    ...
                    if len(batch_data) >= batch_size:
                        execute_values(
                            cur,
                            """INSERT INTO shoreline_buildings 
        ...
        print(f"\n✓ Successfully inserted {row_count} rows into shoreline_buildings")
        if skipped_rows > 0:
...
def load_building_data():
    ...
    try:
        ...
        insert_shoreline_buildings_batch(conn, csv_file, regions, building_types)
